/* ============================================================
   MediCart - Express Server
   Main entry point for the Medical Shop Management System
...
async function seedAdminStaff() {
  try {
    ...
    if (!existing) {
      ...
      await admin.save();
      console.log('👤 Admin staff created — admin@medicart.com / admin123');
    }
